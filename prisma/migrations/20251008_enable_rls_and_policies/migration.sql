...
-- for user data isolation and public catalog access.
...
ALTER TABLE IF EXISTS "public"."KvMeta" ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "public"."MtgCard" ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "public"."Set" ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "public"."SearchIndex" ENABLE ROW LEVEL SECURITY;
